...
export default defineComponent({
	...
	setup() {
		...
		accountStore.fetchAccounts(); // 계좌 목록을 가져옵니다.

		return {
			accountStore, // Store를 반환하여 템플릿에서 사용 가능하게 합니다.
		};
	},
});
</script>
