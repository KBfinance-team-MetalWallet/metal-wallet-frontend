<template>
    <div :class="$style.div">
        ...
        <div :class="$style.cardParent">
            <div :class="$style.card">
                <div :class="$style.cardFrame">
                    ...
                    <img :class="$style.imageIcon" :src="imageIcon" alt="Image" />
        ...
        <div :class="$style.groupParent1">
            ...
            <img :class="$style.groupInner" :src="group122Image" alt="Group 122" />
